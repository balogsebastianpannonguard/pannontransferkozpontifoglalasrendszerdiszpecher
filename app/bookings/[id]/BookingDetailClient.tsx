        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <button
                onClick={() => router.push("/bookings")}
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-indigo-700 text-white text-xs font-black tracking-wider uppercase shadow-lg shadow-indigo-600/30 hover:-translate-y-0.5 hover:shadow-xl transition-all"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-0">
            <div className="p-7 lg:border-r border-slate-200">
              ...
              <div className="relative pl-5">
                <div className="absolute left-1.5 top-1 w-3 h-3 rounded-full bg-emerald-500 shadow-md ring-2 ring-emerald-100" />
                <div className="absolute left-[11px] top-5 bottom-5 w-0.5 bg-gradient-to-b from-emerald-300 via-slate-200 to-rose-300 border-l border-dashed border-slate-300" />
                <div className="absolute left-1.5 bottom-1 w-3 h-3 rounded-full bg-rose-500 shadow-md ring-2 ring-rose-100" />
                <div className="pb-6">
